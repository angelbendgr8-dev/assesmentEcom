<div class="w-full md:w-1/3 xl:w-1/4 p-6 flex flex-col">
    <div>
        <img class="hover:grow hover:shadow-lg" src="{{ $product->image?? null }}">
        <div class="pt-3 flex items-center justify-between">
            <p class="">{{ $product->name?? null }}</p>
                ...
                <svg class="w-10 h-10" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <g id="SVGRepo_iconCarrier">
                        ...
                        <path
                            ...
                            fill="#000000"></path>
                        <path d="M12.5 10.87H13.5V9.37H15V8.37H13.5V6.87H12.5V8.37H11V9.37H12.5V10.87Z" fill="white">
                        </path>
                    </g>
                </svg>
            </button>
        </div>
        <p class="pt-1 text-gray-900">₦{{ $product->price?? null }}</p>
    </div>
</div>
